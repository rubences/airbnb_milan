...
df2["review_scores_rating"] = df2["review_scores_rating"].replace({0: "NO", 1: "SI"})
df2.head()
print(df2.shape)
...
df2["CATEGORÍA"] = pd.cut(df2["review_scores_rating"], bins=[0, 49, 75, 100], labels=["NO ACONSEJABLE", "ESTÁNDAR", "TOP"])
